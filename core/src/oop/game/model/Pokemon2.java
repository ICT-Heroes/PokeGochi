 ...
 * 
 */
public class Pokemon2 extends ModelClass {
	...
	/**
	 * @return int Total: Sum of Speed, SpDefense, SpAttack, HP, Attack, and
	 *         Defense
	 */
	public int getTotal() {
		return Total;
	...
	/**
	 * @return ArrayList<Description> DescriptionList: All the descriptions of
	 *         the Pokemon from all games
	 */
	...
	/**
	 * @return ArrayList<Pokemon> EvolutionsList: An ArrayList of all Pokemon
	 *         that this Pokemon can evolve to
	 */
	public ArrayList<Pokemon2> getEvolutions() {
		ArrayList<Pokemon2> evolutionList = new ArrayList<Pokemon2>();

		if (!Evolutions.isEmpty()) {
			for (int i = 0; i < Evolutions.size(); i++) {
				Pokemon2 p = new Pokemon2(Evolutions.get(i));
				evolutionList.add(p);
			}
		} else {
			return null;
	...
	/**
	 * @return ArrayList<EggGroup> EggGroupList: An ArrayList of all Egg groups
	 *         this Pokemon belongs to
	 */
	...
	/**
	 * @return ArrayList<Move> MovesList: An ArrayList containing all of the
	 *         possible Moves this Pokemon can learn
	 */
